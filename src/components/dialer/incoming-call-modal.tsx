...
export function IncomingCallModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <Card className="w-full max-w-md mx-4 bg-gradient-to-br from-slate-900 to-blue-900 border-black/20 shadow-2xl animate-in fade-in-0 zoom-in-95 duration-300">
        <CardContent className="p-8 text-center">
          ...
          <div className="relative mb-6">
            ...
            <Avatar className="relative h-24 w-24 mx-auto ring-4 ring-green-400/50">
              <AvatarFallback className="bg-gradient-to-br from-green-500 to-green-600 text-black text-2xl">
          ...
          {/* Caller Info */}
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-black mb-2">Incoming Call</h2>
            <p className="text-xl text-black/90 font-semibold mb-1">{callerName}</p>
            <p className="text-lg text-black/70 mb-2">{callerNumber}</p>
            {callerLocation && (
          ...
          {/* Call Duration */}
          <div className="flex items-center justify-center text-black/60 text-sm mb-6">
          ...
          <div className="flex justify-center space-x-6">
            <Button
              onClick={rejectCall}
              className="h-16 w-16 rounded-full bg-red-600 hover:bg-red-700 text-black shadow-lg hover:shadow-xl transition-all duration-200"
            >
            ...
            <Button
              onClick={acceptCall}
              className="h-16 w-16 rounded-full bg-green-600 hover:bg-green-700 text-black shadow-lg hover:shadow-xl transition-all duration-200 animate-pulse"
            >
