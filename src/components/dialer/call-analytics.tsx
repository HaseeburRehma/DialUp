    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card className="bg-white border-slate-200 shadow-sm">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-slate-500 text-sm">Total Calls</p>
                ...
                <Card className="bg-white border-slate-200 shadow-sm">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-slate-500 text-sm">Today's Calls</p>
                                <p className="text-2xl font-bold text-slate-900">{stats.todaysCalls}</p>
                            </div>
                ...
                <Card className="bg-white border-slate-200 shadow-sm">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-slate-500 text-sm">Avg Duration</p>
            ...
            <Card className="bg-white border-slate-200 shadow-sm">
                <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-xl font-semibold text-slate-900">Call Activity</h3>
                            ...
                            {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day, i) => {
                                ...
                                return (
                                    <div key={i} className="text-center">
                                        <div
                                            className="bg-blue-100 rounded-lg mb-2 flex items-end justify-center"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card className="bg-white border-slate-200 shadow-sm">
                    <CardContent className="p-6">
                        <h3 className="text-xl font-semibold text-slate-900 mb-4">Call Status Distribution</h3>
                ...
                <Card className="bg-white border-slate-200 shadow-sm">
                    <CardContent className="p-6">
                        <h3 className="text-xl font-semibold text-slate-900 mb-4">Call Direction</h3>
                        <div className="space-y-3">
                            {[
                                ...
                                <div key={direction} className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                        <Phone className={`h-4 w-4 ${direction === 'outbound' ? 'text-blue-500' : 'text-green-500'}`} />
                                        <span className="text-slate-700 capitalize">{direction}</span>
                                    </div>
